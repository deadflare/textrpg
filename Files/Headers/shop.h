...
int shop(){
	...
	while(true){
		...
		else if(action == "3"){cout << "\nThe shop is a large, rectangular room, dimly lit. Half of the room is dedicated to offensive supplies, the other half to defensive. An intimidatingly large woman sits at a dark wooden desk with a number of drawers and chests around it.\n";}
		else{cout << "\ninvalid input\n";}
	}
}
